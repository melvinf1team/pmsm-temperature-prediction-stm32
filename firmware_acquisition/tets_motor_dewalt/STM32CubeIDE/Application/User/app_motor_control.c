...
static void AppMotorControl_HandleButtonToggle(void)
{
  ...
  app_motor_next_start_attempt_ms = 0U;
  AppDatalog_SendText("#B2,START_REQUESTED,random_rpm=2000-4000,iq_limit_a=30,hard_limit_a=30\r\n");
}
                                                ...
                                                MCI_State_t mc_state)
{
  ...
  {
    AppDatalog_SendText("#B2,START,random_rpm=2000-4000,iq_limit_a=30,hard_limit_a=30\r\n");
  }
  else
  {
    app_motor_next_start_attempt_ms = now + APP_START_RETRY_PERIOD_MS;
